...
import { Building2, CalendarRange, LayoutDashboard, ListChecks, LogOut, ScanLine, Shield, Store as StoreIcon, Landmark } from "lucide-react";
...
function AdminLayout() {
  ...
  const items = [
    ...
    { to: "/admin/agenda", label: "Agenda", icon: <CalendarRange className="h-4 w-4" /> },
    ...
    { to: "/admin/marketplace", label: "Marketplace", icon: <StoreIcon className="h-4 w-4" /> },
    { to: "/admin/pagamentos", label: "Pagamentos", icon: <Landmark className="h-4 w-4" /> },
